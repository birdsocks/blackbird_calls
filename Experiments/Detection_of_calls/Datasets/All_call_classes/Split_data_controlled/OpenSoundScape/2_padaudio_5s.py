...
padded_output_dir = os.path.join(call_audios_dir, "padded_5s")
...
for wav_file in wav_files:
    ...
    # Calculate total samples needed for 5 seconds
    target_samples = int(target_duration * sample_rate)
    current_samples = len(audio.samples)
    
    # Only pad if duration is less than 5 seconds
    if current_duration < target_duration:
        ...
        # If already 5 seconds or longer, trim to exactly 5 seconds
