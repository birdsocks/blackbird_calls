...
model_path = "/home/Shelby/blackbird_calls/Experiments/Detection_of_calls/Datasets/All_call_classes/YOLO_v1/runs/detect/train6/weights/best.pt"

# Load the trained model
model = YOLO(model_path)

# Path to dataset configuration
data_yaml = "/home/Shelby/blackbird_calls/Experiments/Detection_of_calls/Datasets/All_call_classes/YOLO_v1/blackbird.yaml"
...
print("\n" + "=" * 70)
print("Results saved to: runs/detect/test/")
print("=" * 70)